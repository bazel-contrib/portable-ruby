    ...
    class JdxPackageCmd < AbstractCommand
      ...
      def rename_bottles(name, disable_yjit)
        ...
        Dir.glob("*.bottle.json").each do |j|
          ...
          json.gsub!(/\.arm64_(sequoia|sonoma|ventura|monterey|big_sur)\./, ".arm64_darwin.")
          json.gsub!(/\.(sequoia|sonoma|ventura|monterey|big_sur)\./, ".x86_64_darwin.")
          ...
          new_json = new_json.gsub(/\.arm64_(sequoia|sonoma|ventura|monterey|big_sur)\./, ".arm64_darwin.")
          new_json = new_json.gsub(/\.(sequoia|sonoma|ventura|monterey|big_sur)\./, ".x86_64_darwin.")
        ...
        Dir.glob("#{name}*.tar.gz").each do |f|
          ...
          r = r.gsub(/\.arm64_(sequoia|sonoma|ventura|monterey|big_sur)\./, ".arm64_darwin.")
          r = r.gsub(/\.(sequoia|sonoma|ventura|monterey|big_sur)\./, ".x86_64_darwin.")
